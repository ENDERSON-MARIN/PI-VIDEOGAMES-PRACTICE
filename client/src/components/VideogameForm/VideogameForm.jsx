...
const VideogameForm = () => {
  ...
  function handleSubmit(e) {
    ...
    if (
      ...
      !dataState.released.trim() &&
      !dataState.rating &&
      !dataState.background_image &&
      !dataState.platforms.length &&
      !dataState.genres.length
    ) {
              ...
              <div className={Style.align}>
                {genres.map((e) => (
                  <div key={e.name}>
                    ...
                    />
                    <span className={Style.nameGenre} name="genres">
                      {e.name}
                    </span>
                  </div>
                ))}
              ...
              <div className={Style.align}>
                {Platforms.map((e) => (
                  <div key={e} className="platforms-form">
                    ...
                    />
                    <span className={Style.nameGenre} name="platforms">
                      {" "}
                      {e}{" "}
                    </span>
                  </div>
